...
public final class NetWorkCenter {
    ...
    public static void post(String url, String paramData, ResponseCallback callback) {
        post(url, paramData, null, null, callback);
    }
    ...
    public static BaseResponse post(String url, String paramData) {
        ...
        post(url, paramData, new ResponseCallback() {
            ...
            public void onResponse(int resultCode, String resultJson) {
                if (200 == resultCode) {
                    BaseResponse r = JSONTools.parse(resultJson, BaseResponse.class);
     ...
     * @param header 请求头
     */
    public static void post(String url, String paramData, List<File> fileList, HashMap<String, String> header, ResponseCallback callback) {
        doRequest(RequestMethod.POST, url, paramData, fileList, header, callback);
    }
    ...
    public static BaseResponse post(String url, String paramData, List<File> fileList) {
        return post(url, paramData, fileList, null);
    }
     ...
     * @return BaseResponse
     */
    public static BaseResponse post(String url, String paramData, List<File> fileList, HashMap<String, String> header) {
        final BaseResponse[] response = new BaseResponse[]{null};
        post(url, paramData, fileList, header, new ResponseCallback() {
            @Override
            public void onResponse(int resultCode, String resultJson) {
                if (200 == resultCode) {
                    BaseResponse r = JSONTools.parse(resultJson, BaseResponse.class);
                    if(StringTools.isEmpty(r.getErrcode())) {
                        r.setErrcode("0");
                    }
                    r.setErrmsg(resultJson);
                    response[0] = r;
    ...
    public static void get(String url, Map<String, String> paramMap, ResponseCallback callback) {
        ...
        doRequest(RequestMethod.GET, url, paramData, null,null, callback);
    }

    public static BaseResponse get(String url) {
        final BaseResponse[] response = new BaseResponse[]{null};
        doRequest(RequestMethod.GET, url, null, null, null, new ResponseCallback() {
            @Override
            public void onResponse(int resultCode, String resultJson) {
                if (200 == resultCode) {
                    BaseResponse r = JSONTools.parse(resultJson, BaseResponse.class);
    ...
    private static void doRequest(final RequestMethod method, final String url,
                                  final String paramData, final List<File> fileList,
                                  final HashMap<String, String> header, final ResponseCallback callback) {
        //如果url没有传入，则直接返回
